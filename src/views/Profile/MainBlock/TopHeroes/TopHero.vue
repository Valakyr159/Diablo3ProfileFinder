<template>
  ...
  <div class="hero-portrait-wrapper mb-5 mb-sm-0">
    ...
    <div class="p-2 bg-dark">
      ...
      <h5 class="text-truncate m-0 text-center tittle-name font-diablo" :class="{'bg-danger': hero.harcore}">
        {{hero.name}}
        <!-- Si es condicional, pintamos la hoja verde -->
        <img v-if="hero.seasonal" src="@/assets/img/leaf.png" width="12px" class= "" alt="seasonal">
      </h5>
      <div class="d-flex justify-content-around border-top border-secondary pt-2 align-items-center mt-2">
